...
import net.ddns.sabi11.thrillio.util.IOUtil;
...
public class DataStore {
	...
	private static Bookmark[][] bookmarks = new Bookmark[BOOKMARKS_TYPE_COUNT][BOOKMARKS_COUNT_PER_TYPE];
...
*/
		String[] data = new String[BOOKMARKS_COUNT_PER_TYPE];
	...
	private static void loadWebLinks() {
		/*
		bookmarks[0][0] = BookmarkManager.getInstance().creatWebLink(2000, "Taming Tiger", "http://www.javaworld.com/article/2072759/core-java/taming-tiger--part-2.html", "http://www.javaworld.com");
		bookmarks[0][1] = BookmarkManager.getInstance().creatWebLink(2001, "How do I import a pre-existing Java project into Eclipse and get up and running?",	"http://stackoverflow.com/questions/142863/how-do-i-import-a-pre-existing-java-project-into-eclipse-and-get-up-and-running", "http://www.javaworld.com/article/2072759/core-java/taming-tiger--part-2.html");
		bookmarks[0][2] = BookmarkManager.getInstance().creatWebLink(2002, "Interface vs Abstract Class", "http://mindprod.com/jgloss/interfacevsabstract.html", "http://mindprod.com");
		...
		*/
		...
		for(String row : data) {
			String[] values = row.split("\t");
			bookmarks[0][colNum++] = BookmarkManager.getInstance().createWebLink(Long.parseLong(values[0]), values[1], values[3], values[4]);
		}
